...
- Позиція, розмір і прозорість усіх трьох панелей, а також розгорнуті секції параметрів — зберігаються в `localStorage`
...
### Імпорт / Експорт
- **💾 Зберегти JSON** — вивантажує весь проєкт: сторінки, елементи й стан усіх трьох плаваючих панелей (позиція, розмір, прозорість, розгорнуті секції параметрів)
