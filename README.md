...
- Позиція, розмір і прозорість усіх чотирьох панелей, а також розгорнуті секції параметрів — зберігаються в `localStorage`
...
### Імпорт / Експорт
- **💾 Зберегти JSON** — вивантажує весь проєкт: сторінки, елементи й стан усіх чотирьох плаваючих панелей (позиція, розмір, прозорість, розгорнуті секції параметрів)
- **📂 Завантажити JSON** — імпортує раніше збережений проєкт разом зі станом панелей (підтримує і старий формат без панелей, і найстаріший — просто масив елементів)
